---
title: "Workplace Dispute v1.1.0.0"
description: "Update to make the Workplace Dispute starter kit compatible outside the federal namespace: schema prefixes changed from msfed_ to msgov_ and naming updated from 'Federal' to 'Government'. Underlying data model releases remain govcdm_."
version: v1.1.0.0
parent: workplace-dispute
release_file: MS-Gov-Workplace-Dispute_managed%20-%201.1.0.0.zip
---
...
This release prepares the Workplace Dispute starter kit for broader government reuse and collaboration by moving away from a federal-specific namespace and naming.
