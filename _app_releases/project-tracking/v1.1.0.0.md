---
title: "Project Tracking v1.1.0.0"
description: "Update to make the Project Tracking starter kit compatible outside the federal namespace: schema prefixes changed from msfed_ to msgov_ and naming updated from 'Federal' to 'Government'. Underlying data model releases remain govcdm_."
version: v1.1.0.0
parent: project-tracking
release_file: MS-Gov-Project-Tracking_managed%20-%201.1.0.0.zip
---
...
This release prepares the Project Tracking starter kit for broader government reuse and collaboration by moving away from a federal-specific namespace and naming.
