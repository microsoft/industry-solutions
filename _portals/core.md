...
The **Core Portal** provides a starting point for building custom portal solutions with USWDS (U.S. Web Design System) styling and essential portal structure components. It's designed to be the starting point from which agencies can build their custom portal solutions.
...
The Core Portal contains no specific business functionality, data tables, or records management features. It's purely a foundational shell designed to be extended with the specific capabilities your agency needs.

<div style="border: 2px solid #ddd; padding: 10px; border-radius: 5px; display: inline-block;">
  <img src="{{ 'assets/portals/core/core-portal-shell.png' | relative_url }}" alt="Core Portal Shell" style="max-width: 100%; height: auto;">
</div>
